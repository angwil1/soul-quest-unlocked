          ...
          <div className="relative pt-8 md:pt-12 lg:pt-16 w-full h-full">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-4 py-12 sm:py-20 text-center">
              ...
              <div className="animate-fade-in">
                ...
                <div className="mb-6 sm:mb-8 lg:mb-20 lg:-mt-16">
                  <p className="text-xs sm:text-lg md:text-2xl lg:text-lg text-white font-bold max-w-xs sm:max-w-3xl lg:max-w-2xl mx-auto leading-relaxed animate-fade-in bg-gradient-to-r from-red-500 to-pink-500 p-1.5 sm:p-4 lg:p-2 rounded-lg sm:rounded-2xl lg:rounded-lg shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-500" style={{ animationDelay: '0.3s' }}>
                    🚀 <span className="text-yellow-300 bg-black px-1 sm:px-2 lg:px-2 py-0.5 sm:py-1 lg:py-0.5 rounded-md sm:rounded-lg lg:rounded-md text-xs sm:text-sm lg:text-xs">NO MORE BORING SWIPES!</span> 🚀
                    <br className="hidden sm:block"/>
                    <span className="block sm:inline mt-1 sm:mt-0 text-xs sm:text-lg md:text-2xl lg:text-lg">Find your <span className="text-yellow-300 underline decoration-1 sm:decoration-2 lg:decoration-1 decoration-yellow-300">SOULMATE</span> with AI!</span>
                  </p>
                </div>
