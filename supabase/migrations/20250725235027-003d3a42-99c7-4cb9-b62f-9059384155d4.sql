...
CREATE INDEX IF NOT EXISTS idx_user_events_user_id_type ON public.user_events(user_id, event_type);
CREATE INDEX IF NOT EXISTS idx_user_events_created_at ON public.user_events(created_at);
CREATE INDEX IF NOT EXISTS idx_email_journeys_user_journey ON public.email_journeys(user_id, journey_type);