-- Create questions table with correct column names matching the existing code
CREATE TABLE IF NOT EXISTS public.questions (
  id SERIAL PRIMARY KEY,
  "Text" TEXT NOT NULL,  -- Capital T to match existing code
...
-- Insert comprehensive quiz questions with correct column name
...
-- Intimacy & Romance
('Physical attraction is essential for a lasting relationship', 'likert', 'attraction', 1.1),
('I believe in love at first sight', 'likert', 'romance', 0.8),
('Emotional intimacy is more important than physical intimacy', 'likert', 'intimacy', 1.2),
('I enjoy grand romantic gestures', 'likert', 'romance', 0.9),
('I prefer subtle expressions of love over dramatic ones', 'likert', 'romance', 0.9);
